...
public class web_class_day {

	
	public static void main(String[] args) throws ClassNotFoundException, SQLException, UnsupportedEncodingException {
		// TODO Auto-generated method stub
		web_class_day cs =new web_class_day();
		List<String> list1=cs.day_class_user("企业网站");
		List<String> list2=cs.day_web_user();
	 ...
	 */
	public List<String> day_class_user(String type) throws SQLException,ClassNotFoundException, UnsupportedEncodingException {
		Date d = new Date();  
	 ...
	 * 输入网站类型查询出前10个网站在本月的使用情况
	 */
	public List<String> day_web_user() throws SQLException,ClassNotFoundException, UnsupportedEncodingException {
		Date d = new Date();  
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");  
