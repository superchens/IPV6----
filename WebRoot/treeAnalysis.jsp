...
var treeMenu = [
	...
	{ level:1, name:"入侵检测"},
	{ level:2, name:"snort检测系统",ico:"images/icon_default.gif",link:"http://10.10.10.227/base/base_main.php"},
	...
	{ level:2, name:"机器学习分析流程",ico:"images/icon_default.gif",link:"main/analysis/ML.html"},
	{ level:2, name:"LOF算法异常评分",ico:"images/icon_default.gif",link:"main/analysis/abnormal_total.html"},
	{ level:2, name:"深度神经网络检测",ico:"images/icon_default.gif",link:"main/analysis/DNN.html"},
	{ level:2, name:"BP神经网络异常检测",ico:"images/icon_default.gif",link:"main/analysis/bp_abnormal.jsp"},
	{ level:2, name:"lstm流量预测",ico:"images/icon_default.gif",link:"main/analysis/lstm_flow_total.html"},
